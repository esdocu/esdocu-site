...
const config: DocsThemeConfig = {
  ...
  head: function useHead() {
    ...
    const socialCard =
      route === '/' || !title
        ? 'https://esdocu.com/og.jpeg'
        : `https://esdocu.com/api/og?title=${title}`
    ...
    return (
      <>
        ...
        <meta name="twitter:site:domain" content="esdocu.com" />
        <meta name="twitter:url" content="https://esdocu.com" />
        <meta
          name="og:title"
