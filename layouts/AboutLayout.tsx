...
export default function AboutLayout({ children, content }: Props) {
  ...
  return (
    <>
      <PageSEO
        title={`Acerca del proyecto Esdocu`}
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          <p>
            Esdocu es un proyecto de traducción al español de documentación de tecnologías open
          ...
          <p>
            ...
            de los repositorios en nuestra cuenta de{' '}
            <a
              href="https://github.com/esdocu"
              target="_blank"
