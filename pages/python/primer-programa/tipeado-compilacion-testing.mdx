...
"Hello World from your python program!" es una salida del programa Python en el archivo `program.py`, que demuestra que el programa Python realmente se ejecutó.

> **Nota**
> 
> En Windows, también es posible ejecutar un programa de Python haciendo doble clic en el archivo de programa respectivo. Pero el inconveniente de esto es que la ventana de la consola se cierra inmediatamente después de que finaliza el programa y no puedes ver la salida del programa.
